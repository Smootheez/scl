...
public class ExampleConfig {
    public static final ConfigOption<Integer> EXAMPLE_INT = ConfigOption.create("example_int", 0, -5, 100).asSliderInt();
    public static final ConfigOption<Boolean> EXAMPLE_BOOL = ConfigOption.create("example_bool", false);
    public static final ConfigOption<Double> EXAMPLE_DOUBLE = ConfigOption.create("example_double", 0.0, 0.0, 2.0);
